    ...
    public partial class frmReport1 : FISCA.Presentation.Controls.BaseForm
    {
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                // 讀取樣版
                Aspose.Words.Document doc = new Aspose.Words.Document(new System.IO.MemoryStream(Properties.Resources.學生個人缺曠獎懲明細表_世界高中));
                Aspose.Words.DocumentBuilder builder = new Aspose.Words.DocumentBuilder(doc);
                doc.MailMerge.Execute(dt);
                // 合併
                doc.MailMerge.DeleteFields();

                string filePath = System.Windows.Forms.Application.StartupPath + "\\Test世界高中學生個人缺曠獎懲明細表.doc";
                // 輸出至Word 
